    ...
    return (
        <MainLayout>
            <Helmet>
                ...
                <link rel="canonical" href={`${import.meta.env.VITE_SITE_URL || 'https://www.kottravai.in'}/refund-policy`} />
                ...
                <meta property="og:url" content={`${import.meta.env.VITE_SITE_URL || 'https://www.kottravai.in'}/refund-policy`} />
