    ...
    return (
        <MainLayout>
            <Helmet>
                ...
                <link rel="canonical" href={`${import.meta.env.VITE_SITE_URL || 'https://www.kottravai.in'}/faq`} />
                ...
                <meta property="og:url" content={`${import.meta.env.VITE_SITE_URL || 'https://www.kottravai.in'}/faq`} />
